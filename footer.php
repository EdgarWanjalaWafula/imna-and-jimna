		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 aos-animate" data-aos="fade-in" data-aos-delay="100"> 
					<img src="<?php echo wp_get_attachment_image_url('33', 'full'); ?>" alt="Imna & Jimnah" class="footer-logo">
				</div>
				<div class="col aos-animate" data-aos="fade-in" data-aos-delay="300">
					<h5 class="footer-h5-border">WHO WE ARE</h5>
					<?php
						wp_nav_menu([
							'menu'            => 'footer',
							'theme_location'  => 'footer',
							'menu_id'         => false,
							'menu_class'      => 'footer-menu list-unstyled d-flex', 
							'depth'           => 2,
				...
				<div class="col aos-animate" data-aos="fade-in" data-aos-delay="500">
					<h5>WHAT WE OFFER</h5>
